...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      imageUrl: '/src/assets/blackjack.png',
    ...
    },
    {
      ...
      imageUrl: '/src/assets/mywebsite.png',
